...
That sentence is a lie. This page is copy/paste of [something from the docs](https://storybook.js.org/docs/writing-docs/mdx#working-with-standalone-documentation-pages).
